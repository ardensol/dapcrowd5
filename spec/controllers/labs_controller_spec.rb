  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved lab as @lab" do
        ...
        post :create, {:lab => { "name" => "invalid value" }}, valid_session
        assigns(:lab).should be_a_new(Lab)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested lab" do
        ...
        Lab.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => lab.to_param, :lab => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the lab as @lab" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Lab.any_instance.stub(:save).and_return(false)
        put :update, {:id => lab.to_param, :lab => { "name" => "invalid value" }}, valid_session
        assigns(:lab).should eq(lab)
      end
